...
<body>
    <h1 id="title">Special Registration</h1>
    <form id="survey-form" action="./database/addUser.php" onsubmit="return validate()" method="POST">
        ...
        <div class="form-group">
            <label for="userType" class="required">Type of User </label>
            <select name="userType" id="userType" placeholder="User Profile" required>
                <option value disabled selected>Select an option</option>
