...
<body>
    ...
    <form id="survey-form" action="status.php" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea id="comments" name="addresses" placeholder="address" cols="30" rows="5" required></textarea>
        </div>
        ...
        <div class="form-group">
            <button id="rzp-button1" class="button" name="save" type="submit">Save and Continue</button>
            </div>
    </form>
